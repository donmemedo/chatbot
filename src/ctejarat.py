...
Models = [
    ...
    # "makhataei/qa-persian-roberta-fa-zwnj-base",
]
# for i in range(20):
for model_checkpoint in Models:
    ...
    def prepare_train_features(examples):
        ...
        for i, offsets in enumerate(offset_mapping):
            ...
            answers = {"answer_start": [examples["answer_start"][sample_index]],
    ...
    my_dataset = load_dataset(path=f"/home/makhataei/Downloads/qawith8model/{model_checkpoint}")
    train_dataset = my_dataset["train"]
    ...
    for i in range(10):
        try:
            tokenizer = AutoTokenizer.from_pretrained(f"makhataei/{model_checkpoint}")
            model = AutoModelForQuestionAnswering.from_pretrained(f"makhataei/{model_checkpoint}")
            ...
            args = TrainingArguments(
                ...
                output_dir=f"/media/makhataei/Backups/zzzz/makhataei/{model_checkpoint}",
            ...
            trainer.push_to_hub()
            tokenizer.push_to_hub(f"makhataei/{model_checkpoint}")
            lr = lr / 2
        except:
            pass
