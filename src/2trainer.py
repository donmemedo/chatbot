...
args = TrainingArguments(
    f"qa-fa-mdeberta-v3-base",
    # output_dir="/media/makhataei/Backups/qa-fa-mdeberta-v3-base",
...
trainer.push_to_hub()
tokenizer.push_to_hub("makhataei/qa-fa-mdeberta-v3-base")
lr = lr / 2

model_checkpoint = "makhataei/qa-fa-mdeberta-v3-base"
print(
    f"-------------------------------------{lr}--------------------------------------------"
)
tokenizer = AutoTokenizer.from_pretrained(model_checkpoint)
